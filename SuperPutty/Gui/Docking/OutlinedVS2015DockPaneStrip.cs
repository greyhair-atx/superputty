/*
 * Derived from DockPanel Suite VS2013DockPaneStrip.cs, Release_3.1.0.
 * Copyright (c) 2007 Weifen Luo.
 * Licensed under the MIT License; see DockPanelSuite.LICENSE.txt.
 */
...
namespace SuperPutty.Gui.Docking
{
    ...
    internal class OutlinedVS2015DockPaneStrip : DockPaneStripBase
    {
        ...
        private static readonly GraphicsPath SharedGraphicsPath = new GraphicsPath();

        private static GraphicsPath GraphicsPath
        {
            get { return SharedGraphicsPath; }
        }
        ...
        public OutlinedVS2015DockPaneStrip(DockPane pane)
            : base(pane)
        {
        ...
        private void DrawTab_Document(Graphics g, TabVS2013 tab)
        {
            ...
            Color inactiveColor = DockPane.DockPanel.Theme.ColorPalette.TabUnselected.Background;
